...
Definition hash_oracle (key:nat) (sndk:nat) :func :=
     (f, ((TNor Q Bl,g)::(TNor C Nat,x)::(TNor Q Nat,a)::(TNor Q Nat,b)::(TNor Q Nat,c)::(TNor Q Nat,d)::[]),
      init (Nor (Var (L d))) (Nor (Num ( 1)));;;
      qfor x (Nor (Num ( 10)))
           (hash_qr (L a) (L c);;; hash_qr (L b) (L d) ;;; hash_qr (L a) (L d)
                ;;; hash_qr (L b) (L c);;;
      qif (ceq Nat (Nor (Var (L c))) (Nor (Num ( key))))
                (qif (ceq Nat (Nor (Var (L d))) (Nor (Num ( sndk))))
                    (init (Nor (Var (L g))) (Nor (Num ( 1)))) (skip)) (skip)), (Nor (Var (L g)))).
...
Definition x_n (size:nat): func :=
   (f1, ((TNor C Nat,n)::(TNor C Nat,m)::(TArray C Nat 5, n1)::(TArray Q FixedP 5, x3)::(TArray Q FixedP 6, x4)
         ::(TNor C FixedP,e)::[]),
               qfor n (Nor (Num ( 5))) (
                nmod (Nor (Var (L m))) (Nor (Var (L n))) (Nor (Num ( 2)));;;
                qif (ceq Nat (Nor (Var (L m))) (Nor (Num ( 0)))) 
                 (ndiv (Nor (Var (L n))) (Nor (Var (L n))) (Nor (Num ( 2)));;;
                  ncadd (Index (L n1) (Var (L n))) (Index (L n1) (Var (L n))) (Nor (Num ( 1))))
                 (ndiv (Nor (Var (L n))) (Nor (Var (L n))) (Nor (Num ( 2)))));;;

               init (Index (L x3) ((Num ( 0)))) (Nor (Var (G x)));;;
               qfor n (Nor (Num ( 5))) (
                   qif (ceq Nat (Nor (Var (L n))) (Nor (Num ( 0))))
                   (skip)
                   (ncsub (Nor (Var (L m))) (Nor (Var (L n))) (Nor (Num ( 1)));;;
                    fmul (Index (L x3) (Var (L n))) (Index (L x3) (Var (L m))) (Index (L x3) (Var (L m)))
                    ));;;
               qfor n (Nor (Num ( 5))) (
                   qif (ceq Nat (Index (L n1) (Var (L n))) (Nor (Num ( 0))))
                   (skip)
                   (ncadd (Nor (Var (L m))) (Nor (Var (L n))) (Nor (Num ( 1)));;;
                    fmul (Index (L x3) (Var (L m))) (Index (L x4) (Var (L n))) (Index (L x4) (Var (L n)))
                    ));;;
                init (Nor (Var (L e))) (Index (L x4) (Num ( 5)))
     ...
     (f, ((TArray Q FixedP 5,x3)::(TNor Q FixedP,x2)::(TNor Q FixedP,e)::
              (TNor C Nat,g)::(TNor C Nat,n)::(TNor C Nat, xc)::(TNor C Nat,fac)
               ::(TNor C FixedP,rc)::(TNor Q FixedP,re)::[]),
                         ...
                         fmul (Index (L x3) (Num ( 0))) (Nor (Var (L x2))) (Nor (Var (G x)));;;
                         fmul (Index (L x3) (Num ( 1))) (Index (L x3) (Num ( 0))) (Nor (Var (L x2)));;;
                         fmul (Index (L x3) (Num ( 2))) (Index (L x3) (Num ( 1))) (Nor (Var (L x2)));;;
                         fmul (Index (L x3) (Num ( 3))) (Index (L x3) (Num ( 2))) (Nor (Var (L x2)));;;
                         fmul (Index (L x3) (Num ( 4))) (Index (L x3) (Num ( 3))) (Nor (Var (L x2)));;;
                         ncadd (Nor (Var (L n))) (Nor (Num ( 1))) (Nor (Var (L n)));;;
                         ncadd (Nor (Var  (L xc))) (Nor (Num ( 1))) (Nor (Var  (L xc)));;;
         qfor g (Nor (Num ( 5))) 
             (qif (iseven (Nor (Var (L g)))) 
                      (ncadd (Nor (Var ((L n)))) (Nor (Var ((L n)))) (Nor (Num ( 2)));;;
                       nfac (Nor (Var (L fac))) (Nor (Var (L n)));;;
                       ncmul (Nor (Var (L xc))) (Nor (Num ( 4))) (Nor (Var (L xc)));;;
                       ...
                       qinv ((Nor (Var (L e)))))
                      (ncadd (Nor (Var ((L n)))) (Nor (Num ( 2))) (Nor (Var ((L n))));;;
                       nfac (Nor (Var (L fac))) (Nor (Var (L n)));;;
                       ncmul (Nor (Var (L xc))) (Nor (Num ( 4))) (Nor (Var (L xc)));;;
                       fndiv (Nor (Var (L rc))) (Nor (Var (L xc))) (Nor (Var (L fac)));;;
                       fmul (Nor (Var (L e))) (Nor (Var (L rc))) (Index (L x3) (Var (L g)));;;
...
Parameter Pi_4 : nat. (*a binary representation of PI/4 *)
     ...
     (f, ((TArray Q FixedP 5,x3)::(TNor Q FixedP,x2)::(TNor Q FixedP,e)::
              (TNor C Nat,g)::(TNor C Nat,n)::(TNor C Nat, xc)::(TNor C Nat,fac)
                ::(TNor C FixedP,rc)::(TNor Q FixedP,re)::[]),
                         ...
                         init (Nor (Var (L re))) (Nor (Var (G x)));;;
                         fmul (Nor (Var (L x2))) (Nor (Var (G x))) (Nor (Var (L re)));;;
                         fmul (Index (L x3) (Num ( 0))) (Nor (Var (G x))) (Nor (Var (L x2)));;;
                         fmul (Index (L x3) (Num ( 1))) (Nor (Var (L x2))) (Index (L x3) (Num ( 0)));;;
                         fmul (Index (L x3) (Num ( 2))) (Nor (Var (L x2))) (Index (L x3) (Num ( 1)));;;
                         fmul (Index (L x3) (Num ( 3))) (Nor (Var (L x2))) (Index (L x3) (Num ( 2)));;;
                         fmul (Index (L x3) (Num ( 4))) (Nor (Var (L x2))) (Index (L x3) (Num ( 3)));;;
                         ncadd (Nor (Var (L n))) (Nor (Var (L n))) (Nor (Num ( 1))) ;;;
                         ncadd (Nor (Var  (L xc))) (Nor (Var  (L xc))) (Nor (Num ( 1))) ;;;
         qfor g (Nor (Num ( 5))) 
             (qif (iseven (Nor (Var (L g)))) 
                      (ncadd (Nor (Var ((L n)))) (Nor (Var ((L n)))) (Nor (Num ( 2)));;;
                       nfac (Nor (Var (L fac))) (Nor (Var (L n)));;;
